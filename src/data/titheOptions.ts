 ...
 *
 * Хүн бүр өөрөөр бичдэг тул аль болох олон хувилбарыг хамруулав. Эдгээр нь
 * `tithe_patterns` хүснэгт хоосон үед нэг удаа суух эхлэл — цаашид загварыг
 * баазаас уншина.
 */
 ...
 */
export function classifyMemo(memo: string, patterns: string[]): DonationKind {

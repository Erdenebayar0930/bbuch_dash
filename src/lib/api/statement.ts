...
const COLUMN_SYNONYMS = {
  ...
  // Хаанбанк нь орлого/зарлагыг «Кредит гүйлгээ» / «Дебит гүйлгээ» гэж КИРИЛЛЭЭР
  // нэрлэдэг — латин "credit"/"debit" нь эдгээрт таарахгүй тул хоёуланг нь бичив
  income: [
    "кредит",
    "орлого",
    "орлогындүн",
  ...
  expense: ["дебит", "зарлага", "зарлагындүн", "debit", "debitamount"],
  ...
  donorName: [
    ...
    "counterpartyname",
    "name",
    // Хамгийн сүүлийн найдвар: «Харьцсан дансны нэр», «Дансны нэр» гэх мэт
    // «эзэмшигч» гэдэг үггүй толгойнууд. Банкны хуулгад «нэр» агуулсан өөр
    // багана ховор тул алдаа заах эрсдэл багатай.
    "нэр",
  ],
} as const;
...
/**
 * `churchAccount` нь давхардлын түлхүүрт л ордог — аль дансны хуулга болохыг
 * сонгодог болтол хоосон. Хожим данс сонгодог болоход түлхүүр нь данс тус бүрд
 * тусдаа болно.
 */

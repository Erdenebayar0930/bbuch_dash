...
const reasons: Record<string, { title: string; description: string }> = {
  ...
  device: {
    title: "Энэ төхөөрөмжийн хандалтыг хаасан байна",
    description:
      "Аюулгүй байдлын үүднээс энэ төхөөрөмжийг идэвхгүй болгосон байна. Тохиргоо → Аюулгүй байдал хэсгээс өөр төхөөрөмж дээрээ идэвхжүүлнэ үү.",
  },
};
